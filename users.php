        ...
        if ($id > 0) {
            ...
            $db->query("INSERT INTO app_users
                (username,full_name,email,mobile,role,password,permissions,status,
                 ...
                 can_authorize_transporter_payments)
    ...
    <tr>
        ...
        <td>
            ...
            <?php else: ?>
                ...
                <?php if(!($v['view_all_despatch']??0) && !($v['view_all_trips']??0) && !($v['view_all_challans']??0) && !($v['view_all_transporter_payments']??0) && !($v['view_all_transporter_bills']??0) && !($v['view_all_agent_commissions']??0)): ?><span class="text-muted small">Own only</span><?php endif; ?>
            <?php endif; ?>
        </td>
